      ...
      <DialogContent className="sm:max-w-lg p-0 gap-0">
        ...
        <div className="space-y-5 px-8 py-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              {assetType === "fiat" && (
                <span className="absolute top-2 right-3 font-space text-xs">✓</span>
              )}
              <div>
              ...
              {assetType === "fiat" && (
                <div className="border-t border-black/20 mt-4 pt-3 text-xs font-space opacity-60">
                  → exchange rates managed automatically
                </div>
              )}
            </button>
        ...
        <div className="flex items-center justify-between border-t border-white/[0.08] px-8 py-4">
          ...
          <button
            ...
            disabled={!assetType}
            className="bg-white text-black px-4 py-2 font-space text-xs uppercase tracking-wide hover:bg-white/90 disabled:opacity-40 disabled:pointer-events-none"
          >
            Create Asset →
          </button>
        </div>
