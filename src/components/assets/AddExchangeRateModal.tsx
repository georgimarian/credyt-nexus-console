...
export function AddExchangeRateModal({ open, onClose, asset, onRateAdded }: AddExchangeRateModalProps) {
  ...
  const readOnlyCls = "w-full bg-white/5 px-3 py-2 font-ibm-plex text-sm text-white/40 border border-white/10 cursor-not-allowed";
          ...
          <div className="border-t border-white/[0.08] mt-5 pt-5">
            ...
            {asset.rates.length === 0 ? (
              ...
              <table className="w-full table-fixed">
                <thead>
                  <tr className="text-xs text-white/40 uppercase tracking-wider border-b border-dashed border-white/15">
                ...
                <tbody>
                  {asset.rates.map((r, i) => {
                    ...
                    return (
                      <tr key={i} className="border-b border-white/[0.08] text-xs font-ibm-plex">
