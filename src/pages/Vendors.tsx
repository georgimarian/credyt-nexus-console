          ...
          <TableBody>
            {vendorCosts.map((c, i) => (
              <TableRow key={i} className="border-foreground/[0.04] transition-all duration-150 hover:bg-accent/20">
                ...
                <TableCell className="px-4 py-3 text-right font-ibm-plex text-sm font-semibold text-terminal-red">${c.amount.toFixed(4)}</TableCell>
                <TableCell className="px-4 py-3 font-ibm-plex text-xs">{c.vendor_name}</TableCell>
                <TableCell className="px-4 py-3 font-ibm-plex text-xs text-terminal-yellow">{c.event_type}</TableCell>
                <TableCell className="px-4 py-3 font-ibm-plex text-xs text-muted-foreground">{c.customer_name}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
