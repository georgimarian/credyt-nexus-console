      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="border border-dotted border-white/20 text-white/60 text-xs px-1.5 py-0.5 font-ibm-plex">v{product.versions[0]?.version || 1}</span>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <textarea
              ...
              className="h-36 w-full border border-dotted border-white/10 bg-white/5 p-4 font-ibm-plex text-xs leading-relaxed focus:outline-none focus:border-white/30"
              spellCheck={false}
            />
          </div>
          <div>
            <label className="block font-space text-xs uppercase tracking-wider text-white/40 mb-2">Result</label>
            <pre className="h-36 overflow-auto border border-dotted border-white/10 bg-white/5 p-4 font-ibm-plex text-xs leading-relaxed text-white/60">
