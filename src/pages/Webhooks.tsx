        ...
        <table className="w-full table-fixed">
          <thead>
            <tr className="border-b border-white/15">
              <th className="w-[40%] px-4 py-3 text-left font-space text-xs uppercase tracking-wider text-white/40 whitespace-nowrap">Endpoint URL</th>
              <th className="w-[25%] px-4 py-3 text-left font-space text-xs uppercase tracking-wider text-white/40 whitespace-nowrap">Events</th>
              ...
              <th className="w-[15%] px-4 py-3 text-left font-space text-xs uppercase tracking-wider text-white/40 whitespace-nowrap">Last Triggered</th>
              <th className="w-[10%] px-4 py-3"></th>
            </tr>
          </thead>
          <tbody>
            {paged.map((wh) => (
              <tr key={wh.id} className="border-b border-white/10 hover:bg-white/[0.02] cursor-pointer" onClick={() => setExpandedId(expandedId === wh.id ? null : wh.id)}>
          ...
          <div className="p-6" style={{ backgroundColor: "rgba(255,255,255,0.02)" }}>
            ...
            <div className="border border-white/10">
              <table className="w-full table-fixed">
                <thead>
                  <tr className="border-b border-white/15">
                    <th className="px-4 py-3 text-left font-space text-xs uppercase tracking-wider text-white/40">Time</th>
                    <th className="px-4 py-3 text-left font-space text-xs uppercase tracking-wider text-white/40">Status</th>
                    <th className="px-4 py-3 text-left font-space text-xs uppercase tracking-wider text-white/40">Event</th>
                    <th className="px-4 py-3 text-left font-space text-xs uppercase tracking-wider text-white/40">Retries</th>
                  </tr>
                </thead>
                <tbody>
                  {wh.deliveries.map((del) => (
                    <tr key={del.id} className="border-b border-white/10 hover:bg-white/[0.02]">
